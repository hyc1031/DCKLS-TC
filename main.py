...
from utils import loss_cal, calculate_ndcg
...
def eval_real_data(hint, tgan, lr_model, sampler, src, ts, label):
    ...
    return acc_list, np.mean(val_kts), test_pred_tbc_list
...
test_real_acc, test_real_kts, test_pred_tbc_list = eval_real_data('test for real data', tatkc, MLP_model, test_real_ngh_finder,
...
ndcg_at_10 = calculate_ndcg(test_label_l_real, test_pred_tbc_list, k=10)
